<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="539071378">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1827096700">
        <_items dataType="Array" type="Duality.Component[]" id="2615834692" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="596348596">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <gameobj dataType="ObjectRef">539071378</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <pos dataType="Struct" type="Duality.Vector3">
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="2007690658">
            <active dataType="Bool">true</active>
            <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
              <A dataType="Byte">255</A>
              <B dataType="Byte">255</B>
            ...
            <rectMode dataType="Enum" type="Duality.Components.Renderers.SpriteRenderer+UVMode" name="Stretch" value="0" />
            <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
              <contentPath dataType="String">Data\Board\coinGold.Material.res</contentPath>
            </sharedMat>
            <spriteIndex dataType="Int">-1</spriteIndex>
            <visibilityGroup dataType="Enum" type="Duality.Drawing.VisibilityFlag" name="Group0" value="1" />
          </item>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="199462038" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="1245167318">
            <item dataType="ObjectRef">1296828646</item>
            <item dataType="ObjectRef">666080256</item>
          </keys>
          <values dataType="Array" type="System.Object[]" id="98934746">
            <item dataType="ObjectRef">596348596</item>
            <item dataType="ObjectRef">2007690658</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">596348596</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="57327606">fab81R5pPEmuZoi7glrHcA==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
